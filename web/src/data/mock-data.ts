...
export const approvals: ApprovalRequest[] = [
  {
    ...
    status: "Pending",
    rationale:
      "Highest revenue risk account with converging support, renewal, and usage decay signals.",
  ...
  },
  {
    ...
    action: "Approve adoption recovery sprint and pricing review",
    owner: "Customer Success Lead",
    priority: "High",
    status: "Ready",
    rationale:
      "Strong upside if stakeholder inactivity is addressed before procurement restarts.",
    estimatedImpact: "Potential to recover account health by 18 points",
...
export const workflowTemplate: WorkflowResponse = {
  ...
  requestSummary:
    "Assess churn risk for Northstar Fiber and propose a governed retention action before renewal.",
  status: "reviewing",
  evidence: [
    {
      id: "ev-1",
  ...
  messages: [
    {
      ...
      summary:
        "Northstar Fiber sits in the highest churn cohort because support strain and low adoption now overlap with the renewal window.",
      recommendation:
        "Do not wait for another telemetry cycle. Treat the account as intervention-ready.",
      confidence: 0.86,
      status: "complete",
    ...
    },
    {
      ...
      summary:
        "Recent account notes reference competitor benchmarking and dissatisfaction with time-to-resolution.",
      recommendation:
        "Anchor the plan around trust recovery and an executive relationship reset, not only discounting.",
      confidence: 0.77,
      status: "watch",
    ...
    },
    {
      ...
      summary:
        "The highest-probability save path combines a short-term commercial offer with a sponsor-level remediation call and a 14-day onboarding reset.",
      recommendation:
        "Route to approval with one named owner, due within 24 hours, and log the action in the audit trail.",
      confidence: 0.81,
      status: "complete",
      evidenceIds: ["ev-1", "ev-2", "ev-3"],
    },
